    ...
    <div class="row">
        <div class ="col-xs-12">
            ...
            <div class="alert alert-info">
                <strong>Selamat Datang di Sistem Informasi Penerimaan Siswa Baru</strong>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-sm-9 col-xs-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">DATA SISWA BARU</h3>
                </div>
                <div class="panel-body">
                     <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No.</th><th>NIS</th><th width="30%">Nama</th><th>Tanggal Lahir</th><th>Alamat</th><th>Tanggal Daftar</th><th>Asal Sekolah</th>
                            </tr>
                        </thead>
                        <tbody>
